...
namespace kernel_selector 
{
    ...
    void tuning_cache_193B_B1_B16(tuning_data& td)
    {
        ...
        td.td.insert({
            ...
            { "10437599469161149176", std::make_tuple("fully_connected_gpu_fb_io_ref", -1) },
            { "4490223883171428014", std::make_tuple("fully_connected_gpu_yxfb_ref", -1) },
            { "2529786184394804665", std::make_tuple("fully_connected_gpu_fb_io_ref", -1) },
            { "6995235840871804844", std::make_tuple("fully_connected_gpu_yxfb_ref", -1) },
            { "1671208365782918441", std::make_tuple("fully_connected_gpu_fb_io_ref", -1) },
