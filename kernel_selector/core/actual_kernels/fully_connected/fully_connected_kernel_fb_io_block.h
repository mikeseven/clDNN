...
namespace KernelSelector {
    ...
    class FullyConnected_fb_io_block : public IGKFullyConnectedKernelBase
    {
    public:
        FullyConnected_fb_io_block() : IGKFullyConnectedKernelBase("fully_connected_gpu_fb_io_block_fp16") {}
