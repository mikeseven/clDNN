...
namespace KernelSelector {
    ...
    class FullyConnected_bs_f_bsv16_b1 : public IGKFullyConnectedKernelBase
    {
    public:
        FullyConnected_bs_f_bsv16_b1() : IGKFullyConnectedKernelBase("fully_connected_gpu_bs_f_bsv16_b1") {}
