...
namespace kernel_selector
{
    ...
    {
        if (p.GetType() != KernelType::AVERAGE_UNPOOLING ||
            o.GetType() != KernelType::AVERAGE_UNPOOLING)
        {
            return false;
        }
    ...
    AverageUnpoolingKernelBase::DispatchData AverageUnpoolingKernelBase::SetDefault(const average_unpooling_params& params) const
    {
    ...
    KernelsData AverageUnpoolingKernelBase::GetCommonKernelsData(const Params& params, const optional_params& options, float estimatedTime) const
    {
