...
namespace KernelSelector 
{
    ...
    JitConstants ConvolutionKernelGEMMLike::GetJitConstants(const ConvolutionParams& params, ConvolutionKernelBase::DispatchData runInfo) const
    {
    ...
    ConvolutionKernelBase::DispatchData ConvolutionKernelGEMMLike::SetDefault(const ConvolutionParams& arg) const
    {
    ...
    bool ConvolutionKernelGEMMLike::Validate(const Params& p, const OptionalParams& o) const
    {
