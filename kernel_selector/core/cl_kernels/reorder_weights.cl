...
#elif defined INPUT0_LAYOUT_OS_IYX_OSV16_TRANSPOSED
    return GET_FILTER_OS_IYX_OSV8_TRANSPOSED_INDEX(INPUT0, o, i, y, x, SUB_GROUP_SIZE);
...
#elif defined OUTPUT_LAYOUT_OS_IYX_OSV16_TRANSPOSED
    return GET_FILTER_OS_IYX_OSV8_TRANSPOSED_INDEX(OUTPUT, o, i, y, x, SUB_GROUP_SIZE);
