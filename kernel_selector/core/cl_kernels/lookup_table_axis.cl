...
KERNEL(lookup_table_axis)(const __global UNIT_TYPE* input0, const __global uint* input1, __global UNIT_TYPE* output)
{
    ...
    {
        uint global_index = offset + input1[val_index + i] * GAP_SIZE;
