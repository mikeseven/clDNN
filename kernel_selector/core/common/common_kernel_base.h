...
namespace KernelSelector 
{
    ...
    protected:
        ...
        void                            FillCLKernelData(clKernelData& kernel, const CommonDispatchData& runInfo, std::string kernel_map_name, std::string jit, std::string entry_point, std::string exe_mode = ROUND_ROBIN, bool weights = false, bool bias = false, int number_of_imputs = 1) const;
    };
}