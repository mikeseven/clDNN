...
namespace KernelSelector 
{
    ...
    protected:
        ...
        Arguments                       GetArgsDesc(uint32_t num_of_input, bool use_weights, bool use_bias, bool use_quantization = false) const;
        ...
        void                            FillCLKernelData(clKernelData& kernel, const CommonDispatchData& runInfo, std::string kernel_map_name, std::string jit, std::string entry_point, std::string exe_mode = ROUND_ROBIN, bool weights = false, bool bias = false, bool quantization = false) const;
    };
}