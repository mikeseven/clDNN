...
namespace KernelSelector 
{
    ...
    void CommonKernelBase::FillCLKernelData(clKernelData& kernel, const CommonDispatchData& runInfo, std::string kernel_map_name, std::string jit, std::string entry_point, std::string exe_mode, bool weights, bool bias) const
    {
        ...
        kernel.kernelString = GetKernelString(kernel_map_name, jit, entry_point, exe_mode);
