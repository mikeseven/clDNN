...
cd "%ROOT_DIR%" && cmake -E make_directory "%SOLUTION_DIR64%" && cd "%SOLUTION_DIR64%" && cmake -G "Visual Studio 14 2015 Win64" "-DCLDNN__INCLUDE_GENERIC_SAMPLE=ON" "-DCLDNN__ARCHITECTURE_TARGET=%SOLUTION_TARGET64%" "-DCLDNN__BOOST_VERSION=%BOOST_VERSION%" "%ROOT_DIR%"
