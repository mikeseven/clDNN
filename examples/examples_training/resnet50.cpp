...
static primitive_id add_batch_norm_layer_grad(topology& topology_inst, const string& layer_name,
...
static primitive_id add_activation_layer(topology& topology_inst, const string& layer_name, 
...
static primitive_id add_activation_grad_layer(topology& topology_inst, const string& layer_name,
                                              const primitive_id& input, const primitive_id& input_grad)
{
