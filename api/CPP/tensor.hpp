...
struct format
{
    enum type : int32_t
    {
        ...
        image_2d_weights_winograd_2x3_s1,  ///< image format for weights, format used for input for winograd convolution, F(2,3) -- filter 3x3 with stride 1
    ...
    static const format_traits& traits(type fmt)
    {
        static const std::map<type, format_traits> traits
        {
            ...
            { image_2d_weights_winograd_2x3_s1, { 1, 1, 2, "xyfb", "bfxy" } } };
    ...
    static bool is_winograd(type fmt) { return (fmt == winograd_2x3_s1_data || fmt == winograd_2x3_s1_weights || fmt == winograd_2x3_s1_fused_weights || fmt == image_2d_weights_winograd_2x3_s1); }
    /// @brief Checks if @p format is of image2d type
    static bool is_image_2d(type fmt) { return (fmt == image_2d_weights_c4_fyx_b || fmt == image_2d_weights_c1_b_fyx || fmt == image_2d_weights_winograd_2x3_s1); }
