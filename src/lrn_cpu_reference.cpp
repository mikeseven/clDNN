    ...
    namespace {
        struct attach {
            attach() {
                ...
                map.insert({std::make_tuple(engine::reference, memory::format::yxfb_f32,     memory::format::yxfb_f32), lrn_cpu_reference::create});
                map.insert({std::make_tuple(engine::reference, memory::format::byxf_f32,     memory::format::byxf_f32), lrn_cpu_reference::create});
                map.insert({std::make_tuple(engine::reference, memory::format::byxf_b24_f32, memory::format::byxf_b24_f32), lrn_cpu_reference::create});
            }
            ~attach() {}
        };
