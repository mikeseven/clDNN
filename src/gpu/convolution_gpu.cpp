...
namespace{
    struct attach {
        attach() {
            ...
            implementation_map<convolution>::add(std::make_tuple(engine_types::ocl, data_types::f32, format::f8_xy16), convolution_gpu::create);
            implementation_map<convolution>::add(std::make_tuple(engine_types::ocl, data_types::f16, format::f8_xy16), convolution_gpu::create);
        }
        ~attach() {}
    };
    attach attach_impl;
