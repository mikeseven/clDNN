...
namespace neural
{
    ...
    const char convolution_code_yxfb_yxio_b1_memory[] = R"__CC(
    ...
    const char convolution_code_yxfb_yxio_b1_vload_memory[] = R"__CC(
        const uint batch_num = INPUT_BATCH_NUM;
    ...
    const char convolution_code_yxfb_yxio_b1_block_memory[] = R"__CC(
#ifdef USE_VECTOR_8
        #define VECTOR_FLOAT float8
