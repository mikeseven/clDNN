...
struct mean_subtract_gpu : is_an_implementation
{
    ...
    mean_subtract_gpu(const mean_subtract& outer)
    ...
    static kernel_data set_kernel_data(const mean_subtract& outer)
    {
    ...
    static gpu::jit_constants get_jit_constants(const mean_subtract& outer, const kernel_data& data)
    {
    ...
    static void implementation(const void *ptr)
    {
        ...
        me->_kernel.run<gpu::input_mem, gpu::output_mem, gpu::input_mem>({kd.gws0, kd.lws0}, input_mem, output_mem, mean_mem);
    }

    static is_an_implementation *create(const mean_subtract& outer) { return new mean_subtract_gpu(outer); }
