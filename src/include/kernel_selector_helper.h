...
inline kernel_selector::weights_layout to_weights_layout(format f)
{
    ...
    case format::image_2d_weights_winograd_2x3_s1:     return kernel_selector::weights_layout::image_2d_weights_winograd_2x3_s1;
    default:
...
static inline cldnn::format::type from_weights_layout(kernel_selector::weights_layout l)
{
    ...
    case kernel_selector::weights_layout::image_2d_weights_winograd_2x3_s1:        return cldnn::format::image_2d_weights_winograd_2x3_s1;
    default:
        return cldnn::format::bfyx;
    }
}
