...
// The least significant digit is on the last(max index) position of the vector.
    ...
    value &operator+=(const std::vector<   T> &arg) { std::transform(std::vector<T>::rbegin(), std::vector<T>::rend(), arg.crbegin(), std::vector<T>::rbegin(), std::plus <T>());      return *this; }
    value &operator+=(const std::vector<negT> &arg) { std::transform(std::vector<T>::rbegin(), std::vector<T>::rend(), arg.crbegin(), std::vector<T>::rbegin(), std::plus <T>());      return *this; }
    value &operator-=(const std::vector<   T> &arg) { std::transform(std::vector<T>::rbegin(), std::vector<T>::rend(), arg.crbegin(), std::vector<T>::rbegin(), std::minus<T>());      return *this; }
    value &operator-=(const std::vector<negT> &arg) { std::transform(std::vector<T>::rbegin(), std::vector<T>::rend(), arg.crbegin(), std::vector<T>::rbegin(), std::minus<T>());      return *this; }
    value &operator*=(const std::vector<   T> &arg) { std::transform(std::vector<T>::rbegin(), std::vector<T>::rend(), arg.crbegin(), std::vector<T>::rbegin(), std::multiplies<T>()); return *this; }
    value &operator*=(const std::vector<negT> &arg) { std::transform(std::vector<T>::rbegin(), std::vector<T>::rend(), arg.crbegin(), std::vector<T>::rbegin(), std::multiplies<T>()); return *this; }
    ...
    value &operator+=(const neural::vector<   T> &arg) { std::transform(std::vector<T>::rbegin(), std::vector<T>::rend(), arg.raw.crbegin(), std::vector<T>::rbegin(), std::plus <T>());      return *this; }
    value &operator+=(const neural::vector<negT> &arg) { std::transform(std::vector<T>::rbegin(), std::vector<T>::rend(), arg.raw.crbegin(), std::vector<T>::rbegin(), std::plus <T>());      return *this; }
    value &operator-=(const neural::vector<   T> &arg) { std::transform(std::vector<T>::rbegin(), std::vector<T>::rend(), arg.raw.crbegin(), std::vector<T>::rbegin(), std::minus<T>());      return *this; }
    value &operator-=(const neural::vector<negT> &arg) { std::transform(std::vector<T>::rbegin(), std::vector<T>::rend(), arg.raw.crbegin(), std::vector<T>::rbegin(), std::minus<T>());      return *this; }
    value &operator*=(const neural::vector<   T> &arg) { std::transform(std::vector<T>::rbegin(), std::vector<T>::rend(), arg.raw.crbegin(), std::vector<T>::rbegin(), std::multiplies<T>()); return *this; }
    value &operator*=(const neural::vector<negT> &arg) { std::transform(std::vector<T>::rbegin(), std::vector<T>::rend(), arg.raw.crbegin(), std::vector<T>::rbegin(), std::multiplies<T>()); return *this; }
