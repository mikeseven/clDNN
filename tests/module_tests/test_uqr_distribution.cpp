...
protected:
    ...
    using uqr_dist = std::conditional_t<!std::is_same<RealType, void>::value,
                                        distributions::uniform_quantized_real_distribution<RealType>,
                                        distributions::uniform_quantized_real_distribution<>>;
    ...
    using expected_uqr_dist_rt = std::conditional_t<!std::is_same<RealType, void>::value, RealType, float>;
