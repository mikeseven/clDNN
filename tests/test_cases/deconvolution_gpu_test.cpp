...
TEST(deconvolution_f32_fw_gpu, basic_wsiz2x2_in2x2x1x1_nopad) {
    ...
    topology topology(
        ...
        data("biases", biases),
        deconvolution("deconv", "input", { "weights" }, { "biases" }, { format::bfyx,{ 0,0,0,0 } }, { format::bfyx,{ 1,1,1,1 } })
    );
...
TEST(deconvolution_f32_fw_gpu, basic_wsiz2x2_in2x2x1x1_pad1) {
    ...
    topology topology(
        ...
        data("weights", weights),
        data("biases", biases),
        deconvolution("deconv", "input", { "weights" }, { "biases" }, { format::bfyx,{ 0,0,1,1 } }, { format::bfyx,{ 1,1,1,1 } })
    );
...
TEST(deconvolution_f32_fw_gpu, basic_wsiz2x2_in2x2x1x1_stride2_nopad) {
    ...
    topology topology(
        ...
        data("weights", weights),
        data("biases", biases),
        deconvolution("deconv", "input", { "weights" }, { "biases" }, { format::bfyx,{ 0,0,0,0 } }, { format::bfyx,{ 1,1,2,2 } })
    );
...
TEST(deconvolution_f32_fw_gpu, basic_wsiz2x2_in2x2x1x1_stride4_pad2) {
    ...
    topology topology(
        ...
        data("weights", weights),
        data("biases", biases),
        deconvolution("deconv", "input", { "weights" }, { "biases" }, { format::bfyx,{ 0,0,2,2 } }, { format::bfyx,{ 1,1,4,4 } })
    );
...
TEST(deconvolution_f32_fw_gpu, basic_wsiz2x2_in2x2x1x2_stride2_pad1) {
    ...
    topology topology(
        ...
        data("weights", weights),
        data("biases", biases),
        deconvolution("deconv", "input", { "weights" }, { "biases" }, { format::bfyx,{ 0,0,1,1 } }, { format::bfyx,{ 1,1,2,2 } })
    );
