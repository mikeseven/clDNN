...
void generic_eltwise_test(cldnn::format test_input_fmt, int input_b, int input_f, int input_y, int input_x, cldnn::eltwise_mode mode,
	...
	topology.add(eltwise("eltwise", "input1", "input2", mode, relu, slope, { format::bfyx,{ 0,0,input_padding_y, input_padding_x } }, { format::bfyx,{ 0,0,output_padding_y, output_padding_x } }));
