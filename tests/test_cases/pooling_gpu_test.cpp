...
TEST(pooling_forward_gpu, basic_max_yxfb_f32_wsiz3x3_wstr1x1_i3x3x1x1_nopad) {
    ...
    topology.add(pooling("pool_prim", "input_prim", pooling_mode::max, { format::bfyx, {0,0,1,1} }, { format::bfyx, {0,0,3,3} }));
...
TEST(pooling_forward_gpu, basic_max_yxfb_f32_wsiz2x2_wstr1x1_i3x3x1x1_nopad) {
    ...
    topology topology;
    topology.add(input_layout("input_prim", input_prim.get_layout()));
    topology.add(pooling("pool_prim", "input_prim", pooling_mode::max, { format::bfyx,{ 0,0,1,1 } }, { format::bfyx,{ 0,0,2,2 } }));
...
TEST(pooling_forward_gpu, basic_max_yxfb_f32_wsiz2x2_wstr2x2_i4x4x1x1_nopad) {
    ...
    topology topology;
    topology.add(input_layout("input_prim", input_prim.get_layout()));
    topology.add(pooling("pool_prim", "input_prim", pooling_mode::max, { format::bfyx,{ 0,0,2,2 } }, { format::bfyx,{ 0,0,2,2 } }));
...
TEST(pooling_forward_gpu, offsets_max_yxfb_f32_wsiz2x2_wstr2x2_i2x2x1x1_zeropad) {
    ...
    topology topology;
    topology.add(input_layout("input_prim", input_prim.get_layout()));
    topology.add(pooling("pool_prim", "input_prim", pooling_mode::max, { format::bfyx,{ 0,0,2,2 } }, { format::bfyx,{ 0,0,2,2 } }, { format::bfyx,{ 0,0,-1,-1 } }));
...
TEST(pooling_forward_gpu, basic_avg_yxfb_f32_wsiz2x2_wstr1x1_i3x3x1x1_nopad) {
    ...
    topology topology;
    topology.add(input_layout("input_prim", input_prim.get_layout()));
    topology.add(pooling("pool_prim", "input_prim", pooling_mode::average, { format::bfyx,{ 0,0,1,1 } }, { format::bfyx,{ 0,0,2,2 } }));
...
TEST(pooling_forward_gpu, offsets_avg_yxfb_f32_wsiz2x2_wstr2x2_i2x2x1x1_zeropad) {
    ...
    topology topology;
    topology.add(input_layout("input_prim", input_prim.get_layout()));
    topology.add(pooling("pool_prim", "input_prim", pooling_mode::average, { format::bfyx,{ 0,0,2,2 } }, { format::bfyx,{ 0,0,2,2 } }, { format::bfyx,{ 0,0,-1,-1 } }));
...
TEST(pooling_forward_gpu, offsets_avg_yxfb_bfyx_f32_wsiz2x2_wstr2x2_i2x2x1x1_outpad2) {
    ...
    for (std::vector<format>::iterator it = formats_to_test.begin(); it != formats_to_test.end(); ++it)
    {
        ...
        topology topology;
        topology.add(input_layout("input_prim", input_prim.get_layout()));
        topology.add(pooling("pool_prim", "input_prim", pooling_mode::average, { format::bfyx,{ 0,0,2,2 } }, { format::bfyx,{ 0,0,2,2 } }, { format::bfyx,{ 0,0,-1,-1 } }, { format::bfyx,{ 0,0,2,2 } }));
...
TEST(pooling_forward_gpu, offsets_max_yxfb_bfyx_f32_wsiz2x2_wstr2x2_i3x3x1x1_outpad2) {
    ...
    for (std::vector<format>::iterator it = formats_to_test.begin(); it != formats_to_test.end(); ++it)
    {
        ...
        topology topology;
        topology.add(input_layout("input_prim", input_prim.get_layout()));
        topology.add(pooling("pool_prim", "input_prim", pooling_mode::max, { format::bfyx,{ 0,0,2,2 } }, { format::bfyx,{ 0,0,2,2 } }, { format::bfyx,{ 0,0,-1,-1 } }, { format::bfyx,{ 0,0,1,1 } }));
...
TEST(pooling_forward_gpu, offsets_avg_yxfb_bfyx_f32_wsiz2x2_wstr2x2_i2x2x1x1_inpad2x1_outpad2) {
    ...
    for (std::vector<format>::iterator it = formats_to_test.begin(); it != formats_to_test.end(); ++it)
    {
        ...
        topology topology;
        topology.add(input_layout("input_prim", input_prim.get_layout()));
        topology.add(reorder("reorder", "input_prim", input_prim.get_layout(), "", { format::bfyx,{ 0,0,0,0 } }, { format::bfyx,{ 0,0,2,1 } }));
        topology.add(pooling("pool_prim", "reorder", pooling_mode::average, { format::bfyx,{ 0,0,2,2 } }, { format::bfyx,{ 0,0,2,2 } }, { format::bfyx,{ 0,0,-1,-1 } }, { format::bfyx,{ 0,0,2,2 } }));
...
TEST(pooling_forward_gpu, offsets_max_yxfb_bfyx_f32_wsiz2x2_wstr2x2_i3x3x1x1_inpad2x1_outpad2) {
    ...
    for (std::vector<format>::iterator it = formats_to_test.begin(); it != formats_to_test.end(); ++it)
    {
        ...
        topology.add(input_layout("input_prim", input_prim.get_layout()));
        topology.add(reorder("reorder", "input_prim", input_prim.get_layout(), "", { format::bfyx,{ 0,0,0,0 } }, { format::bfyx,{ 0,0,2,1 } }));
        topology.add(pooling("pool_prim", "reorder", pooling_mode::max, { format::bfyx,{ 0,0,2,2 } }, { format::bfyx,{ 0,0,2,2 } }, { format::bfyx,{ 0,0,-1,-1 } }, { format::bfyx,{ 0,0,1,1 } }));
...
TEST(pooling_forward_gpu, avg_yxfb_bfyx_f32_wsiz2x2_wstr2x2_i2x2x1x1_inpad2x1_outpad2) {
    ...
    for (std::vector<format>::iterator it = formats_to_test.begin(); it != formats_to_test.end(); ++it)
    {
        ...
        topology.add(input_layout("input_prim", input_prim.get_layout()));
        topology.add(reorder("reorder", "input_prim", input_prim.get_layout(), "", { format::bfyx,{ 0,0,0,0 } }, { format::bfyx,{ 0,0,2,1 } }));
        topology.add(pooling("pool_prim", "reorder", pooling_mode::average, { format::bfyx,{ 0,0,2,2 } }, { format::bfyx,{ 0,0,2,2 } }, { format::bfyx,{ 0,0,0,0 } }, { format::bfyx,{ 0,0,2,2 } }));
