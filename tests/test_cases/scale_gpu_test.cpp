...
TEST(scale_gpu, basic_in2x3x2x2_scale_scalar) {
    ...
    for (int j = 0; j < 2; ++j) { //F
        for (int i = 0; i < 2; ++i) { //B
            for (int k = 0; k < 2; ++k) { //X
                for (int l = 0; l < 3; ++l) { //Y
                    int linear_id = i + 2 * j + 2 * 2 * l + 2 * 2 * 3 * k;
...
TEST(scale_gpu, basic_in2x3x2x2_scale_x) {
    ...
    auto input = memory::allocate(engine, { data_types::f32,{ format::yxfb,{ 2, 3, 2, 2 } } });
    auto scale_input = memory::allocate(engine, { data_types::f32,{ format::yxfb,{ 2, 1, 1, 1 } } });
...
TEST(scale_gpu, basic_in2x3x2x2_scale_y) {
    ...
    auto input = memory::allocate(engine, { data_types::f32,{ format::yxfb,{ 2, 3, 2, 2 } } });
    auto scale_input = memory::allocate(engine, { data_types::f32,{ format::yxfb,{ 1, 3, 1, 1 } } });
...
TEST(scale_gpu, basic_in2x3x2x2_scale_xy) {
    ...
    auto input = memory::allocate(engine, { data_types::f32,{ format::yxfb,{ 2, 3, 2, 2 } } });
    auto scale_input = memory::allocate(engine, { data_types::f32,{ format::yxfb,{ 2, 3, 1, 1 } } });
...
TEST(scale_gpu, basic_in2x3x2x2_scale_batch1) {
    ...
    auto input = memory::allocate(engine, { data_types::f32,{ format::yxfb,{ 2, 3, 2, 2 } } });
    auto scale_input = memory::allocate(engine, { data_types::f32,{ format::yxfb,{ 2, 3, 2, 1 } } });
    ...
    for (int j = 0; j < 2; ++j) { //F
        for (int i = 0; i < 2; ++i) { //B
            for (int k = 0; k < 2; ++k) { //X
                for (int l = 0; l < 3; ++l) { //Y
                    int linear_id = i + 2 * j + 2 * 2 * l + 2 * 2 * 3 * k;
                    int linear_id_scale = j + 2 * l + 2 * 3 * k;
                    EXPECT_NEAR(output_ptr[linear_id], input_vec[linear_id] * scale_input_vec[linear_id_scale], 1e-05F);
                }
            }
        }
